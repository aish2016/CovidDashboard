 ...
 $scope.getStatesData= function(){
          statesService.getStatesData().then(
            ...
            $scope.statesDataCounts = Object.keys($scope.statesData).reduce(function (accumalator , state) {
              ...
              console.log(state + " " + $scope.statesData[state][stateDateData[stateDateData.length-1]].total + " " + $scope.statesData[state][stateDateData[stateDateData.length-1]].total.deceased)
              ...
              if($scope.statesData[state][stateDateData[stateDateData.length-1]].total && $scope.statesData[state][stateDateData[stateDateData.length-1]].total.confirmed)
               accumalator[0].push(($scope.statesData[state][stateDateData[stateDateData.length-1]].total.confirmed)|| 0)
               ...
               accumalator[1].push(($scope.statesData[state][stateDateData[stateDateData.length-1]].total.recovered)|| 0)
               ...
               accumalator[2].push(($scope.statesData[state][stateDateData[stateDateData.length-1]].total.tested)|| 0)
               if($scope.statesData[state][stateDateData[stateDateData.length-1]].total && $scope.statesData[state][stateDateData[stateDateData.length-1]].total.deceased)
               accumalator[3].push(($scope.statesData[state][stateDateData[stateDateData.length-1]].total.deceased)|| 0)
               else
               accumalator[3].push( 0)
               return accumalator
            }, [
            [],[],[],[]
            ]);
            ...
            $scope.statesDataTestedCounts =  $scope.statesDataCounts[2].chunk_inefficient(12)

            $scope.statesDataDeathCounts =  $scope.statesDataCounts[3].chunk_inefficient(12)
